...
<div class="signup-page">
    <div class="form">
        ...
        <p class="alert alert-info">
            <marquee behavior="" scrollamount="2" direction="">You need to create an account to book/view Ferry!
            </marquee>
        </p>
        <form class="login-form" method="post" role="form" enctype="multipart/form-data" id="signup-form"
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary btn-block mb-4" id="btn-signup">
                        Sign up
                    </button>
                </div>
            </div>
